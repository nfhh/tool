...
class CreateTestsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('tests', function (Blueprint $table) {
            ...
            $table->string('hardware')->default('')->comment('硬盘型号');
            $table->string('netface')->default('')->comment('网络接口');
            $table->string('usb')->default('')->comment('外接U盘');
            $table->string('check')->default('')->comment('脚本测试结果');
            $table->timestamps();
        });
    }
